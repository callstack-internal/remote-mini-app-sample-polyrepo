...
import TechGalleryNavigator from './TechGallery';

export type TabsParamList = {
  HomeNavigator: undefined;
  ServicesNavigator: undefined;
  AccountNavigator: undefined;
  TechGalleryNavigator: undefined;
};
...
const galleryIcon = Icon.getImageSourceSync('folder-image', 24);
...
const TabsNavigator = () => {
  return (
    <Tabs.Navigator
      ...
      />
      <Tabs.Screen
        name="TechGalleryNavigator"
        component={TechGalleryNavigator}
        options={{
          title: 'Gallery',
