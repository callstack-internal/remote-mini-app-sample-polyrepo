    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPluginV2({
        ...
        remotes: {
          ...
          // techGal: `techGal@http://localhost:9005/${platform}/mf-manifest.json`, // local development
          techGal: `techGal@https://raw.githubusercontent.com/callstack-internal/remote-mini-app-sample-polyrepo/refs/heads/main/techGallery/build/generated/${platform}/mf-manifest.json`, // remote (github) Simula como si esto estuviera en producción
